	...
	<div class="app-contain" :style='{"padding":"20px 20px","margin":"20px auto 40px","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">座位数</div>
					<div  class="info_text" >{{detail.zuoweishu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">设备施设</div>
					<div  class="info_text" >{{detail.shebeishishe}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">预约状态</div>
					<div  class="info_text" >{{detail.yuyuezhuangtai}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'预约')" @click="yuyuedingdanonAcross('预约','yuyuedingdan','','yuyuezhuangtai','已预约','已预约,未预约'.split(',')[0])" type="warning">预约</el-button>
...
<script setup>
	...
	const yuyuedingdanonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
		if(!context?.$toolUtil.storageGet('frontToken')){
